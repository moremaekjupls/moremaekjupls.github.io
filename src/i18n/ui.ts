...
export const ui = {
  ru: {
    ...
    'manifesto.text': 'Чтобы построить продукт, больше не нужно уметь писать код — нужны идея и воображение, чтобы за ней пойти.',
  ...
  en: {
    ...
    'manifesto.text': 'You no longer need to write code to build a product — you need an idea, and the imagination to chase it.',
